...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(["name" => "Show-Beneficiary", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Donor", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Faq", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Bill", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Supplier", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Currency", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Service", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Country", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-City", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Area", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-Campaign", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-ContactRequest", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-CampaignBeneficiary", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-CampaignDonor", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-CampaignService", "guard_name" => "admin"]);
        ...
        Permission::create(["name" => "Show-CampaignImage", "guard_name" => "admin"]);
